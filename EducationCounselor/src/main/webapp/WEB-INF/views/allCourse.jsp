...
<li>
	...
	<tr class="danger">
				...
				<td>${clist.book }</td>
				<td>
				<input type="button" class="btn btn-success" onclick="editstudent(${clist.id})" value="Edit">
				<input type="button" class="btn btn-danger" onclick="deletestudent(${clist.id})" value="Delete">
				</td>
			</tr>
	</c:forEach>
	</tbody>
...
<script type="text/javascript">
	function editstudent(id){
		window.location="${pageContext.request.contextPath}/"+id+"/editCourse";
	}
	function deletestudent(id){
		var msg=confirm("do you want to delete ? ");
		if(msg==true){
			window.location="${pageContext.request.contextPath}/"+id+"/deleteCourse";
		}
	}
