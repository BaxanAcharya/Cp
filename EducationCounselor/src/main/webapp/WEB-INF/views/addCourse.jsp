...
<li class="active">
		...
		<div class="content">
            <div class="container-fluid" >
                <div class="col-md-9">
                         <form class="form-containerr" method="post" action="addcourse"  >
            <h1 class="text-black">Course Form</h1>
           

              <div class="form-group">
                <label class="text-black" >Course Name:</label>
                <input type="text" class="form-control" required="required" name="course" >
              </div>
              <div class="form-group">
                <label class="text-black" >Book Name:</label>
                <input type="text" class="form-control" required="required" name="book" >
              </div>
              <div class="from-group">
                <label class="text-black">Institute_id:</label>
                <input type="number" class="form-control" required="required" name="i_id" >
              </div>
