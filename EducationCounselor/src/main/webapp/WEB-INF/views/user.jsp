...
<li>
 ...
 <li >
	...
	<tr class="danger">
				<td>${ulist.firstname}</td>
				<td>${ulist.lastname }</td>
				<td>${ulist.password }</td>
				<td>${ulist.username }</td>
				<td><img src="${pageContext.request.contextPath}/resources/images/${ulist.image}" class="img-responsive" alt="ddhfksd"
				style=" height:400px; width:300px; "></td>
				<td>${ulist.usertype }</td>
				<td>
				<input type="button" class="btn btn-success" onclick="editstudent(${ulist.id})" value="Edit">
				<input type="button" class="btn btn-danger" onclick="deletestudent(${ulist.id})" value="Delete">
				</td>
			</tr>
	</c:forEach>
	</tbody>
...
<script type="text/javascript">
	function editstudent(id){
		window.location="${pageContext.request.contextPath}/"+id+"/editUser";
	}
	function deletestudent(id){
		var msg=confirm("do you want to delete ? ");
		if(msg==true){
			window.location="${pageContext.request.contextPath}/"+id+"/deleteUser";
		}
	}
