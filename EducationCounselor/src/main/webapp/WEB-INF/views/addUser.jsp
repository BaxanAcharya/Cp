...
<li>
 ...
 <li >
		...
		<div class="content">
            <div class="container-fluid" >
                <div class="col-md-9">
                         <form class="form-containerr" method="post" action="adduser" enctype="multipart/form-data" >
            <h1 class="text-black">User Form</h1>
           <h1 style=" color:red; "> ${ex }</h1>
    ...
    <option>teacher</option>
              ...
              <div class="form-group">
                <label class="text-black">Lastname</label>
