		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Add Institute</a>
                </div>
...
<li>
		...
		<div class="content">
            <div class="container-fluid" >
                <div class="col-md-9">
                         <form class="form-containerr" method="post" action="addinstitute" enctype="multipart/form-data" >
            <h1 class="text-black">Institute Form</h1>
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" required="required" name="fee.resourceFee" >
              </div>
              <div class="form-group">
                <label class="text-black">Lab Fee</label>
                <input type="number" class="form-control"  name="fee.labFee" >
              </div>
              <div class="form-group">
                <label class="text-black">EAC Fee</label>
                <input type="number" class="form-control"  name="fee.ECA" >
              </div>
